...
- `GET /api/tools`: lista las herramientas disponibles, sus endpoints y la ruta web dedicada.

El frontend está disponible en la ruta raíz y consume la API para cada herramienta. Cada herramienta también tiene una página individual en `/tools/<id>.html` (por ejemplo `/tools/text-analyzer.html`) con su propio formulario y enlaces de vuelta al catálogo.
